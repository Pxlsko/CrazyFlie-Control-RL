...
class TestRandomPointAviary(BaseRLAviary):
    def __init__(self,
        ...
        if self.trajectory_type == "circle":
            ...
            self.WAYPOINTS = self._generate_random_waypoints(self.CENTER, self.RADIUS, 1)
    ...
    def _computeTerminated(self):
        ...
        # if self.success_steps >= 30:  # Por ejemplo, 20 pasos consecutivos
        #     print(f"[INFO] Objetivo mantenido durante {self.success_steps} steps: {self.TARGET_POS}")
        #     return False
