...
class RandomPointAviary(BaseRLAviary):
    ...
    def __init__(self,
        ...
        self.TARGET_POS = self._sample_grid_point()               # ② usa la función
        self.EPISODE_LEN_SEC = 15
        self.survival_decay = 0.00002  # Cuánto se reduce por paso
        self.survival_r = 0.1  # Valor inicial de recompensa de supervivencia
    ...
    def _sample_grid_point(self):
        GRID = np.arange(0.5, 3.1, 0.5)                           #   [0.5,1,1.5,2,2.5,3]
    ...
    def _computeReward(self):
        ...
        # Para 15 segundos de episodio funciona bien:
        pos_k = 0.008
        ori_k = 0.003
        lin_vel_k = 0.0002
        ang_vel_k = 0.0002
        ...
        # act_k = 0.00002
        # fin_r = 0 
        # survival_r = 0.0333  # Recompensa por supervivencia
        survival_r = self.survival_r
        ...
        # Recompensa total
        total_r = pos_r + ori_r + lin_vel_r + ang_vel_r + act_r + survival_r + fin_r

        self.survival_r = max(0.0, survival_r - self.survival_decay)        
        return total_r
    ...
    def _computeTerminated(self):
        ...
        if np.linalg.norm(self.TARGET_POS - state[0:3]) < 0.1:  
            ...
            print(f"[INFO] Nuevo objetivo generado: {self.TARGET_POS}")
            self.survival_r = 0.1
            return False  
